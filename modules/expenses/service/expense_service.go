...
func (s *expenseService) FindAllCategories(ctx context.Context) ([]dto.ExpenseCategoryResponse, error) {
	...
	for _, c := range list {
		out = append(out, dto.ExpenseCategoryResponse{ID: c.ID.String(), Name: c.Name})
	}
	return out, nil
}
...
func (s *expenseService) FindAllExpenses(ctx context.Context) ([]dto.ExpenseResponse, error) {
	...
	for _, e := range list {
		out = append(out, dto.ExpenseResponse{ID: e.ID.String(), EmployeeID: e.EmployeeID.String(), CategoryID: e.CategoryID.String(), Amount: e.Amount, Description: e.Description, ReceiptURL: e.ReceiptURL, Status: e.Status})
	}
	return out, nil
}
...
func (s *expenseService) UpdateExpense(ctx context.Context, id uuid.UUID, req dto.ExpenseUpdateRequest) (dto.ExpenseResponse, error) {
	...
	if req.CategoryID != nil {
		e.CategoryID = uuid.MustParse(*req.CategoryID)
	}
	if req.Amount != nil {
		e.Amount = *req.Amount
	}
